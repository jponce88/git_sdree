...
-- Generated 2023.08.25 20:10:59 by ADMIN
-- This script can be run in sqlplus as the owner of the Oracle Apex owner.
begin
    wwv_flow_api.set_security_group_id(p_security_group_id=>4778515265440504);
end;
/
----------------
-- W O R K S P A C E
...
wwv_flow_fnd_user_api.create_company (
  p_id                           => 4778614630440520,
  p_provisioning_company_id      => 4778515265440504,
  p_short_name                   => 'TEST',
...
wwv_flow_fnd_user_api.create_fnd_user (
  p_user_id      => '4778406862440504',
  p_user_name    => 'ADMIN',
  p_first_name   => '',
  p_last_name    => '',
  p_description  => '',
  p_email_address=> '',
  p_web_password => '85FFDA996E9A50452E576966E79F0AE2',
  p_web_password_format => 'HEX_ENCODED_DIGEST_V2',
  p_group_ids    => '',
  p_developer_privs=> 'ADMIN:CREATE:DATA_LOADER:EDIT:HELP:MONITOR:SQL',
  p_default_schema=> 'TEST',
  p_account_locked=> 'N',
  p_account_expiry=> to_date('202308251927','YYYYMMDDHH24MI'),
